...
Έπειτα, κάθε γραμμή που υπολογίζει η διεργασία-παιδί, αφότου διασφαλίστει μέσω του κατάλληλου semaphore ότι είναι η σειρά της να τυπώθει, τυπώνεται στο τερματικό. Πλέον, μπορούμε να προχωρήσουμε στην εκτύπωση νέας γραμμής, για αυτό απελευθερώνουμε τον επόμενο σεμαφόρο.
