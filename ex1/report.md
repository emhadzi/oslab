...
<div style="text-align: center;">
  <img src="batchTimes.png" width="50%">
</div>
...
- Δέχεται ως τρίτο όρισμα το πλήθος bytes που θα θέλαμε να γραφτούν `batch_sz`
- Επιστρέφει το πλήθος bytes που πραγματικά γράφτηκε `read_sz`
